...
Transaction.prototype.isCoinStake = function() {
   return this.ins.length > 0 && (!this.ins[0].isCoinBase()) && this.outs.length >=2 && this.outs[0].isNull();
};
...
TransactionSignatureSerializer.prototype.serialize = function() {
  ...
  // ppcoin
  // don't include nTime in the serialization for signatures
  // serialize nTime
